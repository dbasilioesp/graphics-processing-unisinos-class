...
Image * GeraImagemAleatoria(){

	Image *image;
    
	image = new Image(largura,altura);
...
Image *GeraImagemCinza(){

	srand((unsigned int)time(NULL));

	Image *image = new Image(largura, altura);
...
void DesenhaImagem(Image *imagem)
{
	if(imagem != NULL){
