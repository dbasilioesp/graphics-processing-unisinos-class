...
void ImagePNM::LePNM(char *nomeDoArquivo)
{
...
void ImagePNM::LePNMTransparent(char *nomeDoArquivo)
{
...
void ImagePNM::CriaPNM(char *nomeDoArquivo)
{
...
void ImagePNM::TransformaMarioEmLuigi(){
...
void ImagePNM::ConverteGrayscale(){
...
void ImagePNM::Coloriza(int r, int g, int b){
...
void ImagePNM::Binariza(int cutPoint){
