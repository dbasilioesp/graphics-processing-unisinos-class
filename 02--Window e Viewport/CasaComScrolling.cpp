...
//
//
// Alterado por Rossana B. Queiroz em 19/09/2011
// Exemplo de scrolling
//*****************************************************
...
void Desenha(void)
{
    ...
    if (largura <= altura) 
        gluOrtho2D (-10.0f + deslocamentoX,  10.0f+ deslocamentoX,(-10.0f + deslocamentoY)*altura/largura, (10.0f + deslocamentoY) *altura/largura);
    else 
        gluOrtho2D ((-10.0f+ deslocamentoX)*largura/altura, (10.0f + deslocamentoX)*largura/altura, -10.0f + deslocamentoY, 10.0f + deslocamentoY);
